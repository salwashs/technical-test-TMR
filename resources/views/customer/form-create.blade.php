    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <p class="nav-link text-white font-weight-bold">Tambah Kustomer</>
                </li>
            </ul>
            <ul class="navbar-nav">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header bg-dark text-white text-center">
                        <h4 class="mb-0">Tambah Kustomer</h4>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="/tambah-kustomer">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="regencySelect" name="regency" disabled>
                                    <option selected disabled>Pilih Kabupaten</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="districtSelect">Kecamatan</label>
                                <select class="form-control" id="districtSelect" name="district" disabled>
